import com.kodilla.kodillagame.Board;
import com.kodilla.kodillagame.CheckerMove;
import com.kodilla.kodillagame.CheckerType;
...
public class BoardTestSuite {
    ...
    public void testGetPossibleMovesForWhiteChecker() {
        ...
        for (String typeOfMove : possibleMoves.keySet()) {
            System.out.println("Move: " + typeOfMove);
